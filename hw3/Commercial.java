...
public class Commercial extends Vehicle {
    ...
    public Commercial(String make, String model, int year, String color, int odometer, int numAxles, FuelType fuelType, LicensePlate licensePlate, double gvwr, int numWheels, String VIN, int seatingCap, int code) {
